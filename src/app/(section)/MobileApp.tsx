...
const MobileApp = () => {
	return (
		<section className="w-full flex h-fit py-12 md:pt-16 md:pb-24 px-4 md:px-[130px]">
			<div className="relative w-full z-0">
				<motion.div
					className="absolute w-full h-full top-9 px-4"
				...
				<motion.div
					className="absolute w-full h-full top-6 p-2"
					initial={{ y: 100, opacity: 0 }}
					whileInView={{ y: 0, opacity: 1 }}
				...
				<motion.div
					className="relative w-full flex flex-col md:flex-row bg-[#000000] rounded-3xl gap-4"
					initial={{ y: 100, opacity: 0 }}
					whileInView={{ y: 0, opacity: 1 }}
				...
				>
					<div className="w-full md:w-3/5 p-7 flex flex-col justify-start items-start gap-6 md:pb-12">
						<div className="w-full flex flex-col gap-3 border-b-[1px] border-b-[#6b2fe4] pb-4">
							<p className="text-xl md:text-5xl font-[800] capitalize text-white font-inter">
								The Opus Mobile App
							</p>
							<p className="text-white font-open.sans text-xs md:text-xl">
								All your home automation needs at your fingertips.
							</p>
						</div>
						<div className="flex flex-col gap-2">
							<p className="text-white font-open.sans text-xs md:text-xl">
								Effortlessly control and monitor devices.
							</p>
							<p className="text-xs md:text-lg text-white font-open.sans">
								Set schedules and create routines for a truly personalized
								experience.
							</p>
							<p className="text-xs md:text-lg text-white font-open.sans">
								Receive instant updates and alerts to stay informed.
							</p>
						</div>
						<div className="w-full flex justify-center md:justify-start items-center gap-4 px-2 md:px-0 pt-4 md:pt-0">
							<div className="flex justify-center items-center gap-2 bg-[#666666] border-[1px] border-[#FFF] px-6 py-3 rounded-lg">
