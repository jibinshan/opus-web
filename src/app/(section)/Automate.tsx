	...
	return (
		<section className="w-full h-full flex flex-col justify-center items-start px-[100px] pt-16 pb-28 gap-12">
			<div className="w-full flex flex-col gap-3 justify-center items-center">
				{/* <p
					className="font-[800] text-5xl font-inter"
					style={{
				...
				<p className="text-[#09060E] font-open.sans font-[600] text-2xl">
					{" "}
				...
				<div className="relative w-full flex justify-center items-center">
					<div className="relative h-fit">
						...
						<div className="absolute w-full h-[130px] bg-white/30 backdrop-blur-lg border-[1px] border-white z-20 -bottom-18 rounded-4xl px-6 py-3">
							<p className="text-center text-[#09060E] text-[20px] font-[700]">
								Smart Lighting
							</p>
							<p className="text-center text-sm">
								Create the perfect ambiance for every moment with intelligent
								lighting systems that adjust to your preferences.
							</p>
						</div>
					</div>
					<div className="absolute w-full h-full flex justify-between top-[230px]">
						<div className="relative">
							...
							<div className="absolute w-full h-[130px] bg-white/30 backdrop-blur-lg border-[1px] border-white z-20 -bottom-18 rounded-4xl px-6 py-3">
								...
								<p className="text-center text-sm">
									Effortlessly connect and control all your smart devices to
									match your unique daily routines and preferences.
								</p>
							</div>
						</div>
						<div className="relative">
							...
							<div className="absolute w-full h-[130px] bg-white/30 backdrop-blur-lg border-[1px] border-white z-20 -bottom-18 rounded-4xl px-6 py-3">
								...
								<p className="text-center text-sm">
									Maintain the ideal temperature with automated thermostats and
				...
				<div className="relative w-full flex justify-center items-center">
					<div className="relative">
						...
						<div className="absolute w-full h-[130px] bg-white/30 backdrop-blur-lg border-[1px] border-white z-20 -bottom-18 rounded-4xl px-6 py-3">
							...
							<p className="text-center text-sm">
								Stay connected with real-time monitoring and automated alarms
					...
					<div className="absolute w-full h-full flex justify-between -top-[230px]">
						<div className="relative">
							...
							<div className="absolute w-full h-[130px] bg-white/30 backdrop-blur-lg border-[1px] border-white z-20 -bottom-18 rounded-4xl px-6 py-3">
								...
								<p className="text-center text-sm">
									{" "}
									Control your home effortlessly using voice assistants or our
						...
						<div className="relative">
							...
							<div className="absolute w-full h-[130px] bg-white/30 backdrop-blur-lg border-[1px] border-white z-20 -bottom-18 rounded-4xl px-6 py-3">
								...
								<p className="text-center text-sm">
									{" "}
									Enjoy seamless control over your TVs, speakers, and other
