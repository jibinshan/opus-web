    ...
    return (
        <section className="w-full h-fit flex flex-col gap-12 justify-center items-center px-4 md:px-[130px] py-8">
            <div className="w-full flex flex-col gap-2 justify-center items-center">
                ...
                <p className="text-[#09060E] font-open.sans text-sm text-center">Discover what our satisfied customer have to say about their experiences with our products/services</p>
            </div>
                                        ...
                                        >
                                            <CardContent className="w-full flex items-center justify-between py-4 px-4 gap-6">
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    <p className="text-[#09060E] font-open.sans max-w-[400px] text-center text-xs">{item?.des}</p>
                                                    <p className="text-sm text-[#09060E] font-open.sans text-center font-[700]">{item?.name}</p>
                                                </div>
                                            </CardContent>
                                        </Card>
                                    )
