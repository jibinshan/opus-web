	...
	return (
		<section className="relative w-full h-full px-4 md:px-[130px] pt-32 pb-32 flex flex-col gap-12">
			<div className="absolute w-full h-full left-0 top-0 flex flex-col gap-12">
				<div className="h-[171px] w-[650px] ml-[170px] flex justify-center">
					{/* <Image
					...
					/> */}
					<svg xmlns="http://www.w3.org/2000/svg" width="598" height="171" viewBox="0 0 598 201" fill="none" preserveAspectRatio="none">
